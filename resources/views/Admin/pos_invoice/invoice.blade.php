        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="sub-heading">Sales No. {{ $sales->tracking_no }}</p>
                    <p class="sub-heading">Sales Date: {{ $sales->created_at->format('d-m-y') }} </p>
...
@endforeach
    ...
    <button onclick="window.print();" class="btn btn-primary btn-print-invoice waves-effect waves-light m-r-20">
Print Me
</button>     
