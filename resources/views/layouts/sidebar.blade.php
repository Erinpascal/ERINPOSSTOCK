  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route("categories.index") }}"><i class="fa fa-user fa-lg"></i> <span> Category </span></a></li>
        <!-- <li class="treeview">
        ...
        <li><a href="#"><i class="fa fa-user fa-lg"></i> <span> Products </span></a></li>
        <li><a href="#"><i class="fa fa-shopping-cart fa-lg"></i> <span> Orders </span></a></li>
        <li><a href="#"><i class="fa fa-book fa-lg"></i> <span> Reports </span></a></li>
